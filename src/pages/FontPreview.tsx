...
const CN_FONTS = [
  ...
  { name: '⑤ Long Cang', family: 'Long Cang', desc: '随性手写·轻松不呆板' },
];
...
export default function FontPreview() {
  useEffect(() => {
    ...
    link.href = 'https://fonts.googleapis.com/css2?family=ZCOOL+KuaiLe&family=ZCOOL+XiaoWei&family=Ma+Shan+Zheng&family=Noto+Serif+SC&family=Long+Cang&family=Nunito:wght@400;600;700&family=Quicksand:wght@400;600;700&family=Fredoka:wght@400;600;700&family=Baloo+2:wght@400;600;700&family=Patrick+Hand&display=swap';
    link.rel = 'stylesheet';
